 ...
 * @author wallace
 */
public class ConsulSaldoView extends javax.swing.JFrame {

    /**
     * Creates new form ConsulSaldoView
     */
    public ConsulSaldoView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsulSaldoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsulSaldoView().setVisible(true);
            }
        });
    }
